...
export abstract class Storage {
    ...
    public abstract list(options: ListStorageOptions): Promise<StorageObject[]>
    ...
    public async diff(storage: Storage, options: SyncStorageOptions = {}): Promise<StorageDiff> {
        const sourceStorageContents = await this.list({...options})
        const targetStorageContents = await storage.list({...options})
